...
params['per1'] = 5.34072     # period of 1st planet
params['tc1'] = 1979.84156    # time of inferior conjunction of 1st planet
...
params['k1'] = 3.4          # velocity semi-amplitude for 1st planet
params['per2'] = 1.422647      # same parameters for 2nd planet ...
params['tc2'] = 1994.9623
params['e2'] = 0.01
params['w2'] = np.pi/2.
params['k2'] = 3.0
params['per3'] = 10.      # same parameters for 2nd planet ...
params['tc3'] = 1994.9623
params['e3'] = 0.01
params['w3'] = np.pi/2.
params['k3'] = 5.0
...
data = data.drop([0,1,2,3,4,5,6,7,26,27,28,29,30]).reset_index(drop=True)
