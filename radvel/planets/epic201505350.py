...
params['per1'] = 7.919520     # period of 1st planet
params['tc1'] = 1980.38319    # time of inferior conjunction of 1st planet
...
params['k1'] = 18.0          # velocity semi-amplitude for 1st planet
params['per2'] = 11.90724      # same parameters for 2nd planet ...
params['tc2'] = 1984.27545
params['e2'] = 0.01
params['w2'] = np.pi/2.
params['k2'] = 6.
params['per3'] = 2.50858      # same parameters for 2nd planet ...
params['tc3'] = 1978.4284
params['e3'] = 0.01
params['w3'] = np.pi/2.
params['k3'] = 10.0
