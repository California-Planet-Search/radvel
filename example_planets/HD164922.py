...
anybasis_params['gamma_k'] = radvel.Parameter(value=0.0, vary=False)       # velocity zero-point for hires_rk
anybasis_params['gamma_j'] = radvel.Parameter(value=1.0, vary=False)       # "                   "   hires_rj
anybasis_params['gamma_a'] = radvel.Parameter(value=0.0, vary=False)       # "                   "   hires_apf
